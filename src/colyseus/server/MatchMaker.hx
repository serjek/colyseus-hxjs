...
extern class MatchMaker {
	...
	function registerHandler(name:String, klass:RoomConstructor<Dynamic>, ?options:Dynamic):Promise<RegisteredHandler<Dynamic>>;
	...
	function getRoomById(roomId:String):Room<Dynamic>;
	...
	function createRoomReferences(room:Room<Dynamic>, ?init:Bool):Promise<Bool>;
	function clearRoomReferences(room:Room<Dynamic>):Void;
